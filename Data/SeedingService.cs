...
namespace ProjetoUdemy.Data
{
    public class SeedingService
    {
        ...
        public SeedingService(ProjetoUdemyContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Bob Brown", "bob@gmail.com", new DateTime(1979, 12, 31), 3500.0, d2);
            Seller s3 = new Seller(3, "Bob Brown", "bob@gmail.com", new DateTime(1998, 1, 15), 2200.0, d1);
